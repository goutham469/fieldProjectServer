...
function SignUpUploadProfilePic() {
  ...
  return (
    <div>
        ...
        <p>This gives other users a good impression on you.</p>
        <p>- If you are not interested to share your picture you can choose any one of the avatar below.</p>
        {
            imageURL?
            <div>
            ...
            :
            <div>
                <h4>Image not choosen</h4>
            </div>
        }
        <form>
            <p style={{textAlign:'left',fontSize:"20px",color:"black",fontFamily:"cursive"}}>Sample avatar's</p>
